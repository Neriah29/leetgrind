    ...
    def checkInclusion(self, s1: str, s2: str) -> bool:
        ...
        for r in range(len(s2)):
            ...
            if r - l + 1 > len(s1):
                ...
                if s2[l] in ValidCharacters: ValidCharacters.discard(s2[l])
                elif s2[l] in originalCounter and secondCounter[s2[l]] == originalCounter[s2[l]]: 
                    ValidCharacters.add(s2[l])
                l += 1
            
            if s2[r] in originalCounter and secondCounter[s2[r]] == originalCounter[s2[r]]:
                ValidCharacters.add(s2[r])
            else:
                ValidCharacters.discard(s2[r])
